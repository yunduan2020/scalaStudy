...
object Test06_ConstructorParams {
  def main(args: Array[String]): Unit = {
    ...
    val student4 = new Student4("jack", 24)
    // println(s"student2: name = ${student4.name}, age = ${student4.age}")
    student4.printInfo()

    val student5 = new Student5("tom", 25)
    println(s"student5: name = ${student5.name}, age = ${student5.age}")

    val student6 = new Student6("carry", 25, school = "HUST")
